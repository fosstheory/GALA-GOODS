...
class AppConstants {
  static const String APP_NAME = 'Gala Goods';
  static const double APP_VERSION = 1.0;

  static const String BASE_URL = 'https://galagoods.com';
  ...
  // Shared Key
  static const String THEME = 'zeekmart_theme';
  static const String TOKEN = 'zeekmart_token';
  static const String COUNTRY_CODE = 'zeekmart_country_code';
  static const String LANGUAGE_CODE = 'zeekmart_language_code';
  static const String CART_LIST = 'zeekmart_cart_list';
  static const String USER_PASSWORD = 'zeekmart_user_password';
  static const String USER_ADDRESS = 'zeekmart_user_address';
  static const String USER_NUMBER = 'zeekmart_user_number';
  static const String USER_COUNTRY_CODE = 'zeekmart_user_country_code';
  static const String NOTIFICATION = 'zeekmart_notification';
  static const String SEARCH_HISTORY = 'zeekmart_search_history';
  static const String INTRO = 'zeekmart_intro';
  static const String NOTIFICATION_COUNT = 'zeekmart_notification_count';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.english, languageName: 'Spanish', countryCode: 'SP', languageCode: 'sp'),
  ];
}
